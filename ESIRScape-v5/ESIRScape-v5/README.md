...
Le joueur incarne un étudiant (ou un ninja) de l'ESIR qui doit rendre son projet de programmation avant la deadline. Il affronte des bugs informatiques, des examens surprises, et finit par combattre le boss final qui bloque l'accès au serveur Moodle.
